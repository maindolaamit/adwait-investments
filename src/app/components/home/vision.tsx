        ...
        <section id="vision" className="bg-gradient-to-r from-blue-500 to-green-500 text-white py-20">
            <div className="container mx-auto flex flex-col md:flex-row items-stretch space-y-5 md:space-y-0 md:space-x-10">
                <div className="md:w-1/2 h-full">
                    <img src="/org/home/quotes-sam.png" alt="Vision Image" className="w-full h-full object-cover rounded-lg shadow-lg" />
                </div>
                <div className="md:w-1/2 h-full flex flex-col justify-center space-y-5">

                    <h2 className="text-4xl font-bold mb-4">Our Investment Philosophy</h2>
                    <p className="text-lg max-w-xl mx-auto">
                        At the heart of Adwait Investments lies a deep belief in the principles of value investing and
                        the
